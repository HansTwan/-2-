...
predictor_1 = TabularPredictor.load("../user_data/model_data/model_1")

test_data = TabularDataset(test).drop('是否流失', axis=1)
prediction_model_1 = predictor_1.predict_proba(test_data)
...
predictor_2 = TabularPredictor.load("../user_data/model_data/model_2")

test_data = TabularDataset(test)
prediction_model_2= predictor_2.predict_proba(test_data.drop(columns=[id]))
...
predictor_3 = TabularPredictor.load("../user_data/model_data/model_3")

test_data = test #TabularDataset('test.csv')
prediction_model_3 = predictor_3.predict_proba(test_data.drop(columns=[id]))
